...
const LoginSignIn = () => {
    ...
    return (
        <reactbootstrap className='container-fluid'>
            ...
            <reactbootstrap.Row className="col-md-12 mr-0 ml-0  mt-1 pt-5" style={{backgroundColor: '#c064c066'}}>
                    <reactbootstrap.Col className="col-md-8 d-flex justify-content-center">
                        My APP
                    </reactbootstrap.Col>
                {loginSignup===1 && <reactbootstrap.Col className="col-md-4 shadow-lg p-3 mb-5 bg-white rounded">
                    ...
                    {loginSignup===2 && <reactbootstrap.Col className="col-md-4  shadow-lg p-3 mb-5 bg-white rounded">
                    <reactbootstrap.Row className="d-flex font-weight-bolder justify-content-center">
                            SIGNIN
                    </reactbootstrap.Row>
                        <SignUp/>
